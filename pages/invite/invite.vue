<template>
	...
	<view class="banner">
		<dl>
			<dt><image src="http://qbrbzkpmz.bkt.clouddn.com/user-avtar.jpg" mode=""></image></dt>
			<dd>倪同学</dd>
		</dl>
		<view class="img">
			<image src="/static/ewm.jpg" mode=""></image>
		</view>
		<view class="tgtit">邀请您来一起赚钱啦</view>
		<view class="sharbuttn">
			<view class="btn" @click="save">保存二维码</view>
			<view class="btn" @click="jump">跳转</view>
